...
Reminded me of the old [AT&T](https://web.archive.org/web/20140627212026/http://www.logoblog.org/wordpress/saul-bass%E2%80%99-times-are-a-changin%E2%80%99
) logo or a more generic technology or telecomm company. The gradient on the sphere does provide some 3d depth to the sphere and demonstrates that since so much of our interactions with logo now take place on screens, where color is cheap, the simplification of logos that used to be necessary is less of a consideration.
